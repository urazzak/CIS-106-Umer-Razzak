def get_quantity():
    print ("Enter the number of tickets purchased: ")
    quantity = int(input())
...
def display_results(quantity, price, total, tax, cost):
    print ("The number of tickets is: " + str(quantity))
    print ("The price of each ticket is: $" + str(price))
